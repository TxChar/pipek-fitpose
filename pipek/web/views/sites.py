...
prototxt_path = os.path.join(base_path, "../views/deploy.prototxt.txt")
model_path = os.path.join(
    base_path, "../views/res10_300x300_ssd_iter_140000.caffemodel"
)
...
@module.route("/requests", methods=["POST", "GET"])
def tasks():
